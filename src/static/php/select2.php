...
$sql = "select ISBN,bname,author,number,bt_name from book,booktype where book.bt_id=booktype.bt_id and bname like '%{$sel}%'";
...
// 查询数据
$strSQL = "select ISBN,bname,author,number,bt_name from book,booktype where book.bt_id=booktype.bt_id and bname like '%{$sel}%' order by book.bid limit $start, $pagesize";
...
<hr>
<div>
    <form action="select.php" id="form" method="get">
...
<div class="container" style="font-size: larger;margin-right: 150px">
    <form action="delete.php" method="get">
        ...
        <p style="text-align: center">
            ...
            <!--            <a href="select.php?page=--><?php //= $page + 1 ?><!--"-->
            <!--               target="_self">后一页</a>-->
            <a href="select2.php?page=<?= $page - 1 ?>&select=<?= $sel ?>"
