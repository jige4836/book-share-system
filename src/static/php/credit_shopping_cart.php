...
$sql = "select book.bid,ISBN,bname,author,bt_name from shopping,book,booktype where book.bt_id=booktype.bt_id and shopping.bid=book.bid and shopping.uid='$uid' order by book.bt_id asc,book.bid asc";//先按分类排，再按序号排
...
// 查询数据
$strSQL = "select book.bid,ISBN,bname,author,bt_name from shopping,book,booktype where book.bt_id=booktype.bt_id and shopping.bid=book.bid and shopping.uid='$uid' order by book.bt_id asc,bid asc limit $start, $pagesize";
